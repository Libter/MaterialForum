    ...
    init: function (editor) {
        editor.on('instanceReady', function () {
            ...
            editor.autolink = function (e) {
                ...
                if (range.toString().replace(new RegExp(fillChar, 'g'), '').match(/(?:https?:\/\/|ftp:\/\/|www\.)/i)) {
                    ...
                    a.href = a.href.replace(document.location.origin, '');
            ...
            if (CKEDITOR.env.webkit) {
                ...
                editor.document.on("keypress", function (e) {
                    if (e.data.getKey() === 32 || e.data.getKey() === 13)
                        editor.autolink(e);
                });
            }
            editor.on("paste", function (e) {
               setTimeout(function() { editor.autolink(e); }, 1); 
            });
        });
    }
});